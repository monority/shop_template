...
const DisplayMode = () => {
	...
	return (
		<>
			<div id="display_mode">
				<svg className="cursor_pointer" width="2.8rem" height="2.8rem" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" onClick={() => toggleTheme()}>
